...
LDFLAGS = -march=native -fno-strict-aliasing -g3 -fopenmp -pthread   #-fsanitize=address 
# note: -fanalyzer doesn't report when -flto is enabled
CFLAGS =  -march=native -fno-strict-aliasing -g3 -fopenmp -Wall -fopt-info-all -fanalyzer #-fsanitize=address 
